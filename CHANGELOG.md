...
## [3.2.1](https://github.com/lotusnoir/ansible-system_network/compare/3.2.0...3.2.1) - 2025-11-29

### Commits

- add no changes on run flag to keep idempotence [`fd96581`](https://github.com/lotusnoir/ansible-system_network/commit/fd96581d6a4eb840d4a0618f054bf159d49f2b79)

## [3.2.0](https://github.com/lotusnoir/ansible-system_network/compare/3.1.0...3.2.0) - 2025-11-25

### Commits

- update main to include success flag at the end to be able to monitor last playbook run [`648469d`](https://github.com/lotusnoir/ansible-system_network/commit/648469dca25ca1a00a86851a4a8c99fd39251cda)
